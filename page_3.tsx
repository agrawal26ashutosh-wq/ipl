...
const OWNERS = [
  ...
  { id:4, name:'Aayush',    color:COLORS[3], marquee:['Jasprit Bumrah','Quinton de Kock','Varun Chakaravarthy'] }, // FIX: QdK → Quinton de Kock
...
const PLAYERS = [
  ...
  {name:'Ryan Rickelton',      ipl:'MI',   cost:1.0,  owner:3, role:'WK'},  // FIX: Rickleton → Rickelton
  ...
  {name:'Nitish Kumar Reddy',  ipl:'SRH',  cost:4.4,  owner:3, role:'AR'},  // FIX: NKR → Nitish Kumar Reddy
  ...
  {name:'Quinton de Kock',     ipl:'MI',   cost:8.2,  owner:4, role:'WK'},  // FIX: QdK → Quinton de Kock
  ...
  {name:'Devdutt Padikkal',    ipl:'RCB',  cost:4.2,  owner:7, role:'BAT'},  // FIX: Paddikal → Padikkal
  ...
  return (
    <div style={{background:'#080B10',color:'#E8EDF5',fontFamily:"'Rajdhani',sans-serif",minHeight:'100vh',overflowX:'hidden'}}>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        @media(max-width:640px){
          ...
          #music-player{bottom:.75rem!important;left:.75rem!important;right:.75rem!important;width:auto!important;}
          .mobile-nav{overflow-x:auto!important;flex-wrap:nowrap!important;-webkit-overflow-scrolling:touch;scrollbar-width:none;padding-bottom:2px;}
          .mobile-nav::-webkit-scrollbar{display:none;}
          .mobile-header-wrap{flex-wrap:wrap!important;height:auto!important;padding:.5rem 0!important;gap:.5rem!important;}
          .mobile-header-logo .title-text{font-size:16px!important;}
          .mobile-header-logo .sub-text{display:none!important;}
          .mobile-match-card{flex-direction:column!important;gap:.5rem!important;}
          .mobile-match-card > div:last-child{text-align:left!important;}
          .main-pad{padding:1rem .75rem!important;padding-bottom:160px!important;}
        }
      `}</style>
      ...
      <header style={{background:'linear-gradient(135deg,#0A0F18,#111827)',borderBottom:'2px solid #FFD700',padding:'0 1.5rem',position:'sticky',top:0,zIndex:100,boxShadow:'0 4px 40px rgba(255,215,0,0.15)'}}>
        <div className="mobile-header-wrap" style={{maxWidth:1400,margin:'0 auto',display:'flex',alignItems:'center',justifyContent:'space-between',height:60,gap:'1rem'}}>
          <div className="mobile-header-logo" style={{display:'flex',alignItems:'center',gap:10,flexShrink:0}}>
            ...
            <div>
              <div className="title-text" style={{fontFamily:"'Bebas Neue',cursive",fontSize:22,letterSpacing:3,background:'linear-gradient(90deg,#FFD700,#FF6B00)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent'}}>The Auction Room</div>
              <div className="sub-text" style={{fontSize:9,color:'#7A8BAA',letterSpacing:3,textTransform:'uppercase',marginTop:-3}}>IPL Fantasy 2026 · 8 Teams</div>
            </div>
          </div>
          <nav className="mobile-nav" style={{display:'flex',gap:2,flexWrap:'wrap'}}>
      ...
      <main className="main-pad" style={{maxWidth:1400,margin:'0 auto',padding:'1.5rem',paddingBottom:120}}>

        {/* LEADERBOARD */}
        {activeView==='leaderboard'&&(
          <div>
            <div className="mobile-match-card" style={{background:'linear-gradient(135deg,#161D2A,#1A2235)',border:'1px solid #2A3550',borderTop:'3px solid #FF6B00',borderRadius:12,padding:'1.25rem 1.75rem',marginBottom:'1.5rem',display:'flex',alignItems:'center',justifyContent:'space-between',boxShadow:'0 8px 32px rgba(0,0,0,0.4)'}}>
